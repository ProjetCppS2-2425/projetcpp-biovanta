/********************************************************************************
** Form generated from reading UI file 'vaccin1.ui'
**
...
""));
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8("projet_c/cher.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
...
"}"));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8("projet_c/vaccin.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        vac_2->setIcon(icon2);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8("projet_c/equipement.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        eq_2->setIcon(icon3);
        client_2 = new QPushButton(sidebare);
        client_2->setObjectName("client_2");
        client_2->setGeometry(QRect(0, 400, 141, 41));
        QIcon icon4;
        icon4.addFile(QString::fromUtf8("projet_c/client.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        client_2->setIcon(icon4);
        test_2 = new QPushButton(sidebare);
        test_2->setObjectName("test_2");
        test_2->setGeometry(QRect(0, 350, 151, 41));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8("projet_c/teste.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
...
""));
        QIcon icon6;
        icon6.addFile(QString::fromUtf8("projet_c/pdf1.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        pdf_2->setIcon(icon6);
...
""));
        QIcon icon7;
        icon7.addFile(QString::fromUtf8("projet_c/st.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8("projet_c/search.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ok_2->setIcon(icon8);
...
"}"));
    ...
    void retranslateUi(QMainWindow *vaccin1)
    {
        ...
        btnRetourEquipement->setText(QCoreApplication::translate("vaccin1", "retour Menu", nullptr));
        btnRetourvaccin->setText(QCoreApplication::translate("vaccin1", "retour Menu", nullptr));
