...
""));
        ...
        cb_rech_emp->addItem(QString());
        cb_rech_emp->addItem(QString());
        cb_rech_emp->setObjectName(QString::fromUtf8("cb_rech_emp"));
...
""));
        QIcon icon;
        icon.addFile(QString::fromUtf8("../projet_c/projet_c/pdf1.png"), QSize(), QIcon::Normal, QIcon::Off);
        pdf_2->setIcon(icon);
...
""));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8("../projet_c/projet_c/st.png"), QSize(), QIcon::Normal, QIcon::Off);
        stat_2->setIcon(icon1);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8("../projet_c/projet_c/search.png"), QSize(), QIcon::Normal, QIcon::Off);
        ok_2->setIcon(icon2);
        ok_2->setIconSize(QSize(40, 40));
        tableView_vaccin = new QTableView(groupBox_2);
        tableView_vaccin->setObjectName(QString::fromUtf8("tableView_vaccin"));
        tableView_vaccin->setGeometry(QRect(10, 180, 701, 321));
        le_rech = new QLineEdit(groupBox_2);
        le_rech->setObjectName(QString::fromUtf8("le_rech"));
...
"    }"));
        ...
        vaccin_id_input->setObjectName(QString::fromUtf8("vaccin_id_input"));
        vaccin_id_input->setGeometry(QRect(64, 120, 71, 31));
        nombre_doses = new QLabel(centralwidget);
        nombre_doses->setObjectName(QString::fromUtf8("nombre_doses"));
...
""));
        ...
        sidebare->setObjectName(QString::fromUtf8("sidebare"));
...
""));
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8("empe.png"), QSize(), QIcon::Normal, QIcon::Off);
        emp->setIcon(icon3);
        chercheur_ = new QPushButton(sidebare);
        chercheur_->setObjectName(QString::fromUtf8("chercheur_"));
        chercheur_->setGeometry(QRect(0, 200, 141, 41));
        QIcon icon4;
        icon4.addFile(QString::fromUtf8("../projet_c/projet_c/cher.png"), QSize(), QIcon::Normal, QIcon::Off);
        chercheur_->setIcon(icon4);
        vac_2 = new QPushButton(sidebare);
        vac_2->setObjectName(QString::fromUtf8("vac_2"));
...
"}"));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8("../projet_c/projet_c/vaccin.png"), QSize(), QIcon::Normal, QIcon::Off);
        vac_2->setIcon(icon5);
        vac_2->setIconSize(QSize(20, 20));
        eq_2 = new QPushButton(sidebare);
        eq_2->setObjectName(QString::fromUtf8("eq_2"));
        eq_2->setGeometry(QRect(0, 300, 141, 41));
        eq_2->setStyleSheet(QString::fromUtf8(""));
        QIcon icon6;
        icon6.addFile(QString::fromUtf8("../projet_c/projet_c/equipement.png"), QSize(), QIcon::Normal, QIcon::Off);
        eq_2->setIcon(icon6);
        client_2 = new QPushButton(sidebare);
        client_2->setObjectName(QString::fromUtf8("client_2"));
        client_2->setGeometry(QRect(0, 400, 141, 41));
        QIcon icon7;
        icon7.addFile(QString::fromUtf8("../projet_c/projet_c/client.png"), QSize(), QIcon::Normal, QIcon::Off);
        client_2->setIcon(icon7);
        test_2 = new QPushButton(sidebare);
        test_2->setObjectName(QString::fromUtf8("test_2"));
        test_2->setGeometry(QRect(0, 350, 151, 41));
        QIcon icon8;
        icon8.addFile(QString::fromUtf8("../projet_c/projet_c/teste.png"), QSize(), QIcon::Normal, QIcon::Off);
        test_2->setIcon(icon8);
...
""));
        ...
        logout_2->raise();
        logo->raise();
        type_vaccin = new QLabel(centralwidget);
        type_vaccin->setObjectName(QString::fromUtf8("type_vaccin"));
