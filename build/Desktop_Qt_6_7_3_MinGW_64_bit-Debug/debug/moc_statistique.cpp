...
struct qt_meta_stringdata_CLASSstatistiqueENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSstatistiqueENDCLASS = QtMocHelpers::stringData(
    "statistique",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSstatistiqueENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject statistique::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_CLASSstatistiqueENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSstatistiqueENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSstatistiqueENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *statistique::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSstatistiqueENDCLASS.stringdata0))
