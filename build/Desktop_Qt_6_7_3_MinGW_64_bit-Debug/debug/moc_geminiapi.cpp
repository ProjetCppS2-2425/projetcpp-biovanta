...
struct qt_meta_stringdata_CLASSGeminiAPIENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSGeminiAPIENDCLASS = QtMocHelpers::stringData(
    "GeminiAPI",
    "responseReady",
    "",
    "reply",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSGeminiAPIENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject GeminiAPI::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSGeminiAPIENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSGeminiAPIENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSGeminiAPIENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<GeminiAPI, std::true_type>,
...
void GeminiAPI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (GeminiAPI::*)(const QString & );
            if (_t _q_method = &GeminiAPI::responseReady; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *GeminiAPI::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSGeminiAPIENDCLASS.stringdata0))
...
// SIGNAL 0
void GeminiAPI::responseReady(const QString & _t1)
{
