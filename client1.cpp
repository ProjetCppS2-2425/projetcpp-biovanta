    ...
    , ui(new Ui::client1)
{
    ...
    connect(ui->radioButton_Ajouter, &QRadioButton::toggled, this, &client1::on_radioButton_Ajouter_toggled);
    connect(ui->radioButton_Modifier, &QRadioButton::toggled, this, &client1::on_radioButton_Modifier_toggled);
    connect(ui->pdf, &QPushButton::clicked, this, &client1::onPdfButtonClicked);
    connect(ui->stat, &QPushButton::clicked, this, &client1::on_stat_clicked);
    connect(ui->todo, &QPushButton::clicked, this, &client1::on_todo_clicked);
...
void client1::checkDatabaseForUID()
{
   /* QSqlQuery query;
...
void client1::on_radioButton_Ajouter_toggled(bool checked)
{
...
void client1::on_pushButton_supp_clicked(){
        ...
        void client1::on_radioButton_Modifier_toggled(bool checked){
            {
                if (checked) {
         ...
         /* void client1::onPdfButtonClicked() {
            QTextDocument doc;
        ...
        void client1::on_History_clicked()
        {
        ...
        void client1::on_Rbar_textChanged(const QString &arg1)
        {
            proxy->setFilterFixedString(arg1);
        }


        void client1::on_CBbar_currentIndexChanged(int index)
        {
            if (index==1){
                index=-1;
            }
        ...
        void client1::on_CBtri_currentIndexChanged(int index)
        {
