    ...
    ui(new Ui::menu)
{
   ...
   //client1interface = new client1();
    ...
    /*if (client1interface) {
        stackedWidget->addWidget(client1interface);
    }*/

    // Connexion manuelle des boutons de retour
...
void menu::on_equip_3_clicked()
{
   ...
   // qDebug() << "Client1 interface created:" << (client1interface != nullptr);
  //  stackedWidget->setCurrentIndex(0);
}
